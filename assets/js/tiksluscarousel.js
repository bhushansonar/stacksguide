...
//nav_left.show();nav_right.show();
                ...
                if (!nav_right.hasClass("navIcons")) {
                    nav_right.addClass("navIcons");
                }
                if (!nav_left.hasClass("navIcons")) {
                    nav_left.addClass("navIcons");
                }
                if (options.current < count) {
                    var tn = parseInt(options.current) + 1;
                    if (!nav_right.hasClass("navIcons_next")) {
                        nav_right.addClass("navIcons_next");
                    }
                ...
                if (options.current > 1) {
                    ...
                    if (!nav_left.hasClass("navIcons_prev")) {
                        nav_left.addClass("navIcons_prev");
                    }
...
//shows a message
        ...
        var init_ = function() {
            ...
            //error handling
            if (options.current > count || options.current < 0) {
                options.current = 1;
                current = 1;
                show_msg_("Invalid <b>Current</b> value. Reset to 1", "error");
            }
            if ($.inArray(options.type, arr) <= -1) {
                show_msg_("Invalid <b>type</b> value. Reset to <b>rotate</b>", "error");
            }
            if ($.inArray(options.nav, arr, 4) <= -1) {
                show_msg_("Invalid <b>nav</b> value. Must be <b>dots</b> or <b>thumbnails</b>", "error");
            }

            if (isNaN(options.animationInterval) || options.animationInterval <= 0) {
                show_msg_("Invalid <b>animationInterval</b> value. Must be > 0", "error");
            }
            if (isNaN(options.dotRatio) || (options.dotRatio < 0.01 && options.dotRatio > 0.1)) {
                show_msg_("Invalid <b>dotRatio</b> value. Must be > 0.01 and < 0.1", "error");
            }
            if (isNaN(options.captionFontRatio) || (options.captionFontRatio < 0.1 && options.captionFontRatio > 1)) {
                show_msg_("Invalid <b>captionFontRatio</b> value. Must be >= 0.1 and <= 1", "error");
            }
            if (isNaN(options.width) || options.width < 0) {
                show_msg_("Invalid <b>width</b> value. Must be >= 0", "error");
            }
            if (isNaN(options.height) || options.height < 0) {
                show_msg_("Invalid <b>height</b> value. Must be > 0", "error");
            }
            if (isNaN(options.captionAnimationInterval) || options.captionAnimationInterval <= 0) {
                show_msg_("Invalid <b>captionAnimationInterval</b> value. Must be > 0", "error");
            }
            if (options.autoPlayInterval <= 0) {
                show_msg_("Invalid <b>autoPlayInterval</b> value. Must be > 0", "error");
            }
            $(".slider_nav").hide();
        ...
        carousel.find(".tslider").mouseenter(function(e) {
            ...
            if (e.relatedTarget.tagName == "a" || e.relatedTarget.tagName == "A") {
                e.preventDefault();
            } else {
    ...
    $.fn.tiksluscarousel = function(options)
    {
        return this.each(function()
        {
            ...
            if (element.data('tiksluscaraousel'))
                return;
