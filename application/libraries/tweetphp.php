...
class tweetphp {
    ...
    public function __construct($options = array()) {
        ...
        $this->options = array_merge(
                array(
            'consumer_key' => 'GwMGgu2apJLdRMFFbuPxGiJgX',
            'consumer_secret' => '7EU3dDqtqJdVJpP21Wzl4WTVTcvBt63G93axmXSYe67bLXPBIj',
            'access_token' => '2849741257-mJ4adbgpqTksySGAPQik9MIHqJymwTRfthiY8mS',
            'access_token_secret' => '6dLXRkzF2kxDpagSC9lALoGW8g8Yd8Nc71lvi7n4SElhX',
            'twitter_screen_name' => 'StacksGuide',
            'cache_file' => dirname(__FILE__) . '/twitter_cache/t   witter.txt', // Where on the server to save the cached formatted tweets
            'cache_file_raw' => dirname(__FILE__) . '/twitter_cache/twitter-array.txt', // Where on the server to save the cached raw tweets
