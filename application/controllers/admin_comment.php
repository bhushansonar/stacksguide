...
class Admin_comment extends CI_Controller {
    ...
    const VIEW_FOLDER = 'admin/comment';
    ...
    public function index() {
        ...
        //load the view
        $data['main_content'] = 'admin/comment/list';
...
//index
    ...
    public function add() {
        ...
        //load the view
        $data['main_content'] = 'admin/comment/add';
        $this->load->view('admin/includes/template', $data);
    }
...
//        echo "<pre>";print_r($_POST);exit;
        ...
        //load the view
        $data['main_content'] = 'admin/comment/edit';
        $this->load->view('admin/includes/template', $data);
    }
...
//update
    ...
    public function status() {
        ...
        $redirect_url = $this->session->userdata('redirect_url');
        redirect($redirect_url);
        //redirect('admin/wanted_add/update/'.$id.'');
    }
