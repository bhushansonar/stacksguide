...
//                }
                ...
                if (@$this->comment_model->store_comment($data_to_store) == TRUE) {
                    $this->session->set_flashdata('flash_message', 'Your comment is awaiting moderation!');
                    $this->session->set_flashdata('flash_class', 'alert-success');
                } else {
                    $this->session->set_flashdata('flash_message', 'Something is wrong please check');
                ...
                $this->session->set_flashdata('flash_message', 'Incorrect Credential');
                $this->session->set_flashdata('flash_class', 'alert-error');
