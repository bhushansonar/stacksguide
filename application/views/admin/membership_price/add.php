<div class="container top">
    ...
    <div class="page-header">
        <h2>
            Adding Membership Price<?php //echo ucfirst($this->uri->segment(2));    ?>
        </h2>
    </div>
    ...
    echo form_open('admin/membership_price/add', $attributes);
    ?>
    <fieldset>
        <div class="control-group">
            ...
            <div class="controls">
                ...
                echo form_dropdown('membership_duration', $membership_duration_opt, "", $attribute);
                ?>
            </div>
        </div>
        <div class="control-group">
