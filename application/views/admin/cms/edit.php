...
?>
        ...
        <div class="control-group">
         ...
         <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="" name="title" value="<?php echo $cms[0]['title']; ?>" >
              <!--<span class="help-inline">Woohoo!</span>-->
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
            <textarea class="tinymce ckeditor" id="editor" name="description" ><?php echo $cms[0]['description']?></textarea>
              <!--<span class="help-inline">Woohoo!</span>-->
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
             <select name="status">
             	<option <?php  echo trim($cms[0]['status']) == 'Active' ? 'selected="selected"' : ''?>  value="Active">Active</option>
                <option <?php echo trim($cms[0]['status']) == 'Inactive' ? 'selected="selected"' : ''?> value="Inactive">Inactive</option>
             </select>
              <!--<span class="help-inline">Woohoo!</span>-->
            </div>
          </div>
