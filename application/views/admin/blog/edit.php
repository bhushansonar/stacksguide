...
<div class="container top">
    ...
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="title" value="<?php echo $blog[0]['title'] ?>" >
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <textarea class="tinymce ckeditor" id="editor" name="description"><?php echo $blog[0]['description'] ?></textarea>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <?php if ($blog[0]['featured_image']) { ?>
                    <div style="float:left;"><img width="100" src="<?php echo base_url(); ?>uploads/blog/<?php echo $blog[0]['featured_image'] ?>" /></div>
                    <span style="display:none;" id="delete_msg">Are you sure to delete this Featured Image?</span>
                    <span class="help-inline"><a href="<?php echo site_url("admin") . '/blog/delete_image/' . $blog[0]['blog_id'] ?>" class="btn btn-danger complexConfirm">Delete</a></span>
                <?php } ?>
