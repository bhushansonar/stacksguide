...
//save the columns names in a array that we will use as filter
                ...
                echo form_open('admin/blog', $attributes);

                echo form_label('Search:', 'search_string');
                echo form_input('search_string', $search_string_selected);
                ?>
                <select name="order" class="span2">
                    <option <?php echo ($order == 'title_en') ? 'selected="selected"' : "" ?>  value="title">Title</option>
...
//echo form_dropdown('order', $options_language, $order, 'class="span2"');
                ...
                if ($search_string_selected) {
                    echo '<a style="margin-left: 12px;vertical-align: middle;" class="btn" href="' . site_url("admin/blog/") . '">Reset</a>';
                }
                echo form_close();
                ?>
...
//    echo '<td style="text-align:center">' . $schedule_status . '</td>';
                  ...
                  <a  href="' . site_url("admin") . '/blog/update/' . $row['blog_id'] . '" class="btn btn-info">view & edit</a>
                  <a href="' . site_url("admin") . '/blog/delete/' . $row['blog_id'] . '" class="btn btn-danger complexConfirm">delete</a>
