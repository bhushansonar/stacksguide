...
<div class="container top">
    ...
    echo form_open_multipart('admin/comment/update/' . $this->uri->segment(4) . '', $attributes);
    ?>
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input  type="text" disabled='disabled' name="title" value="<?php echo $comment[0]['title']; ?>" >
            </div>
        </div>
        <div class="control-group">
