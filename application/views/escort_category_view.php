...
$name = $ci->common_model->getFieldData('city', 'city_name', $where);
//$count_escort1 = $ci->home_model->CountEscort($city, $cat_id);
?>
<!--<style>
    .escortcat_menu > div {
        float: left;
            ...
            <article class="main_left" style="width: 100%">
                ...
                <div class="main_box">
                    <div class="escortcat_menu">
                        ...
                        foreach ($subcategorys as $key => $subcat) {
                            $count = $ci->stackguide_ads_model->get_count_advertisement($city, $subcat['category_id']);
                            ?>
                            <div><a href="<?php echo site_url() ?>home/get_escort_details/<?php echo $city ?>/<?php echo $subcat['category_id']; ?>" style="color: #fff;font-size: 14px;line-height: 25px;"><?php echo $subcat['category_name']; ?><span style="color: #fff">(<?php echo $count; ?>)</span></a></div>
                        <?php }
                        ?>
                    </div>
                </div>
                <div class="affilate_main">
                    ...
                    <div class="featurd_main">
                        <?php
                        $escort = $ci->stackguide_ads_model->get_advertisement_by_city($city);
                        foreach ($escort as $key => $getAllEscort) {
                            ...
                            <div class="featurd_cantain">
                                ...
                                <p>Seduction Waiting To Be Experienced.. Visiting <?php echo ucfirst($city) ?> **Prebooking Now** </p>
                            </div>
                        <?php } ?>
                    </div>
                    <hr class="sg_border"/>
