    ...
    <section>
        <div class="main_part">
            <div class="affilate_main">
                ...
                <hr class="sg_border">
                <div class="featurd_main" style="margin: 20px 0 10px 9px;">
                    <?php foreach ($events as $key => $row) {
                        ?>

                        <div class="featurd_cantain" style="text-align: center; margin: 0 2%; width: 96%;">
                            <h4 class="featurd_gictit">
                                <a target="_blank"href="<?php echo $row['events_site'] ?>"><?php echo $row['events_title'] ?></a>
                            </h4>
                            <div style="font-size: 14px;"class="featurd_date">
                                <?php echo $row['events_description']; ?>
                            </div>
                        </div>
                    <?php } ?>
                </div>
